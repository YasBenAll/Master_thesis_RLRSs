...
python /var/scratch/yal700/Master_thesis_RLRSs/pretrain_gems.py --latent-dim 16 --multi True --slate-size 3 --num-items 1000 --latent-dim 16 --seed 2023 --n-users 100000 --concurrent True --env-id SlateTopK-BoredInf-v0
