...
python /var/scratch/yal700/Master_thesis_RLRSs/train.py --agent hac --seed $SEED --total-timesteps 500000 --val-interval 5000 --policy-frequency 1 --observable True --buffer-size 100 --env-id sardine/SlateTopK-Bored-v0 --morl False --learning-starts 10000 --observable True --ml100k True