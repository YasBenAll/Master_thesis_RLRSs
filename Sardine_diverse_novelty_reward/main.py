...
logging_policy = EpsilonGreedyOracle(epsilon = 0.5, env = env, seed = 2023)
dataset = env.generate_dataset(n_users = 100, policy = logging_policy, seed = 2023, dataset_type="dict")
